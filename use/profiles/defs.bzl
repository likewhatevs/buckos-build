"""Profile presets as constraint_value lists.

Shared between platform() definitions in use/profiles/BUCK and modifier
aliases in use/modifier_aliases.bzl.  Single source of truth for each
profile's flag set.
"""
