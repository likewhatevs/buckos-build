...
def main():
    ...
    output_dir = os.path.join(_scratch_base, "gcc-configure-work")
    ...
    # paths (--with-build-sysroot, build dir in config.status) so the
    # downstream build phase sees the final artifact location.
